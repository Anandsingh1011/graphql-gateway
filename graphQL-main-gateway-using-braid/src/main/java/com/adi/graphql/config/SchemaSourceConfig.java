...
public class SchemaSourceConfig {
    ...
    private static final String USERS_SCHEMA_URL = "http://localhost:8081/app1/graphql"; //This one can be read from config

    private static final String BOOKS_SCHEMA_URL = "http://localhost:8082/app2/graphql";
    ...
    public SchemaSource userSchemaSource() {
        return querySchemaSourceBuilder("users", USERS_SCHEMA_URL, Collections.emptyList());
    }
